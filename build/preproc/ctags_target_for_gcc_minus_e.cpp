# 1 "C:\\Users\\Aniello\\Desktop\\Folders\\Arduino Files\\DenoiseMIDIController\\DenoiseMIDIController.ino"
/*** Start of code ***/
/*
...
# 19 "C:\\Users\\Aniello\\Desktop\\Folders\\Arduino Files\\DenoiseMIDIController\\DenoiseMIDIController.ino" 2
  ...
  public:
    ...
    void DoProcess() {
      ...
      for (int i = 0; i < 3; i++) { // Take 3 samples of the analog input
        ...
        if ( ((Val - NewVal)>0?(Val - NewVal):-(Val - NewVal)) > 1 ) NewVal = Val; // Is there's a difference of one or more than the threshold value?
